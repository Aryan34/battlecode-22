...
public strictfp class RobotPlayer {
    ...
    static void runArchon(RobotController rc) throws GameActionException {
        ...
        int[] dirlist = new int[5];
        dirlist[0] = 0;
        dirlist[1] = 1;dirlist[2] = 1;dirlist[3] = 6;dirlist[4] = 7;
        if (rn<100) {

            if (dirlist[rng.nextInt(2)]!=0) {
    ...
    //else if (stay){
        if (count==0){
            ...
            // int[] dirlist = new int[5];
            // dirlist[0] = 2;
            // dirlist[1] = 4;dirlist[2] = 5;dirlist[3] = 6;dirlist[4] = 7;
            int rand = rng.nextInt(directions.length);
            // if (me.x>40 && me.y >40){
            //     rand = dirlist[rng.nextInt(4)];
            // }
            Direction dir2 = directions[rand];
            if (rc.canMove(dir2)) {
                rc.move(dir2);
                System.out.println("I moved!");
            }
